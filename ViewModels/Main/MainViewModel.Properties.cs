...
namespace OpenCvWpfTracking.ViewModels.Main
{
    ...
    public partial class MainViewModel
    {
        ...
        /// HOME / ZERO UI 표시 여부.
        ///
        /// 환경부 전용 V1에서는 HOME / ZERO 기능을 지원하지 않으므로
        /// 장비 상태와 관계없이 항상 숨긴다.
        /// </summary>
        public bool IsHomeZeroVisible =>
            IsHomeZeroFeatureEnabled &&
        ...
        /// 2026-08-24: AUTO SCAN 중 PRESET 탭 전환과 상태 확인만 허용한다.
        /// </summary>
        ...
        /// AUTO SCAN 중에는 PRESET W 화면 확인과 스크롤을 허용하지만,
        ...
        /// [EO] 주간 [RTSP] 주소
        ///
        /// 통신 설정 탭의 EO RTSP TextBox와 양방향 바인딩한다.
        /// </summary>
        ...
        /// [IR] 열상 [RTSP] 주소
        ///
        /// 통신 설정 탭의 IR RTSP TextBox와 양방향 바인딩한다.
        /// </summary>
